...
//ORDER MICROSERVICE
docker run -d --name node-order-service --network microservices-network -p 8081:8081 -e PORT=8081 -e APP_NAME=ORDER-SERVICE node-order-service:latest

//CUSTOMER MICROSERVICE
docker run -d --name customer-service --network microservices-network -p 8080:8080 -e PORT=8080 -e APP_NAME=CUSTOMER-SERVICE -e ORDER_SERVICE=order-service:8081 node-customer-service:latest

// REACT FRONTEND
docker run -d --name react-frontend --network microservices-network -p 3000:80 react-frontend:latest
